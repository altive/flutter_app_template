...
class UpdateRankingMemberOrder {
  ...
  RankingMemberDocumentReference _myRankingMemberDocRef({
    required String rankingId,
    required String memberId,
  }) {
    return rankingsRef.doc(rankingId).members.doc(memberId);
  }
  ...
  Future<void> call({
    ...
    if (newOrder == null) {
      ...
      final newDocs = <RankingMemberQueryDocumentSnapshot>[];
