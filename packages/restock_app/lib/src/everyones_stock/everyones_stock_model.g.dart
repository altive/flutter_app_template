...
_$_EveryonesStockModel _$_$_EveryonesStockModelFromJson(Map json) {
  return _$_EveryonesStockModel(
    createdAt:
    ...
    expirationAt:
        const TimestampConverter().fromJson(json['expirationAt'] as Timestamp?),
...
Map<String, dynamic> _$_$_EveryonesStockModelToJson(
